...
* <p>
*/
public class RedisInput extends InputAdapter implements Parameterizable, Runnable {

	public static final long serialVersionUID = 1663719335820L;
	...
	*/
	...
	protected void fillAndOutputTuple() {
		if (getLogger().isInfoEnabled()) {
			getLogger().info("fill the tuple and output the tuple...");
		}
		try {
			shouldRun();
	...
	public String getChannelPath() {
		...
		return cleanChannelPath.isEmpty()? "*" : cleanChannelPath;
	}
