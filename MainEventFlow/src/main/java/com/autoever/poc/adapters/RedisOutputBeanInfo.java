	...
	*/
	public SBPropertyDescriptor[] getPropertyDescriptorsChecked() throws IntrospectionException {
		SBPropertyDescriptor[] p = {
				new SBPropertyDescriptor("redisPort", RedisOutput.class).displayName("Redis Server port")
						.description("").optional(),
				new SBPropertyDescriptor("redisHost", RedisOutput.class).displayName("Redis Host IP Address")
						.description("").optional(), };
		return p;
	}
