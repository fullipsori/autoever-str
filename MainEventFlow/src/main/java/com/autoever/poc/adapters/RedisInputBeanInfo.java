	...
	*/
	public SBPropertyDescriptor[] getPropertyDescriptorsChecked() throws IntrospectionException {
		SBPropertyDescriptor[] p = {
				new SBPropertyDescriptor("redisPort", RedisInput.class).displayName("Redis Server Port")
						.description("").optional(),
				new SBPropertyDescriptor("redisHost", RedisInput.class).displayName("Redis Host IP Address")
						.description("").optional(),
				new SBPropertyDescriptor("channelPath", RedisInput.class).displayName("Redis Subscription Channel")
						.description("").optional(), };
		return p;
	}
